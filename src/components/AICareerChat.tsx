    ...
    >
      <div className="flex items-center gap-2.5 border-b border-line px-5 py-4">
        ...
        <div>
          ...
          <p className="text-xs text-muted">Powered by OpenRouter · gpt-oss-120b</p>
        </div>
      </div>
      ...
      >
        ...
        <button
          ...
          className="flex h-9 w-9 flex-none items-center justify-center rounded-full bg-accent text-background transition-opacity disabled:opacity-40"
        >
          <Send size={15} />
        </button>
      </form>
